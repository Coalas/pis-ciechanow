...
Header( "HTTP/1.1 301 Moved Permanently" ); Header( "Location: http://www.pis-ciechanow.pl/wybory/index.php" ); die(); 
}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <span class="bodyText">
            <?php echo $bodyText; ?>
	    <?php wp_redirect(get_option('siteurl') . '/wybory/index.php'); ?>
